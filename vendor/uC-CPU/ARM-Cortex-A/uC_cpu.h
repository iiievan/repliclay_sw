...
*               path directories.
*
*           (3) Since NO custom library modules are included, 'uC_cpu.h' may ONLY use configurations from
*               CPU configuration file 'cpu_cfg.h' that do NOT reference any custom library definitions.
*
*               In other words, 'uC_cpu.h' may use 'cpu_cfg.h' configurations that are #define'd to numeric
...
*
* Note(s) : (1) Configure CPU_CFG_STK_GROWTH in 'uC_cpu.h' with CPU's stack growth order :
*
...
*                   function(s) in :
*
*                   (1) 'cpu_a.asm',  if CPU_CFG_LEAD_ZEROS_ASM_PRESENT       #define'd in 'uC_cpu.h'/
*                                         'cpu_cfg.h' to enable assembly-optimized function(s)
*
*                   (2) 'cpu_core.c', if CPU_CFG_LEAD_ZEROS_ASM_PRESENT   NOT #define'd in 'uC_cpu.h'/
...
*                   function(s) in :
*
*                   (1) 'cpu_a.asm',  if CPU_CFG_TRAIL_ZEROS_ASM_PRESENT      #define'd in 'uC_cpu.h'/
*                                         'cpu_cfg.h' to enable assembly-optimized function(s)
*
*                   (2) 'cpu_core.c', if CPU_CFG_TRAIL_ZEROS_ASM_PRESENT  NOT #define'd in 'uC_cpu.h'/
*                                         'cpu_cfg.h' to enable C-source-optimized function(s) otherwise
*********************************************************************************************************
*/
...
*
*               (a) 'uC_cpu.h'/'cpu_a.asm',       if CPU_CFG_LEAD_ZEROS_ASM_PRESENT      #define'd in 'uC_cpu.h'/
*                                                 'cpu_cfg.h' to enable assembly-version function
*
*               (b) 'cpu_core.h'/'cpu_core.c', if CPU_CFG_LEAD_ZEROS_ASM_PRESENT  NOT #define'd in 'uC_cpu.h'/
...
#error  "CPU_CFG_ADDR_SIZE              not #define'd in 'uC_cpu.h'               "
...
#error  "CPU_CFG_ADDR_SIZE        illegally #define'd in 'uC_cpu.h'               "
#error  "                         [MUST be  CPU_WORD_SIZE_08   8-bit alignment]"
#error  "                         [     ||  CPU_WORD_SIZE_16  16-bit alignment]"
#error  "                         [     ||  CPU_WORD_SIZE_32  32-bit alignment]"
#endif
...
#error  "CPU_CFG_DATA_SIZE              not #define'd in 'uC_cpu.h'               "
#error  "                         [MUST be  CPU_WORD_SIZE_08   8-bit alignment]"
#error  "                         [     ||  CPU_WORD_SIZE_16  16-bit alignment]"
#error  "                         [     ||  CPU_WORD_SIZE_32  32-bit alignment]"
...
#error  "CPU_CFG_DATA_SIZE        illegally #define'd in 'uC_cpu.h'               "
#error  "                         [MUST be  CPU_WORD_SIZE_08   8-bit alignment]"
#error  "                         [     ||  CPU_WORD_SIZE_16  16-bit alignment]"
#error  "                         [     ||  CPU_WORD_SIZE_32  32-bit alignment]"
#endif
...
#error  "CPU_CFG_ENDIAN_TYPE            not #define'd in 'uC_cpu.h'   "
...
#error  "CPU_CFG_ENDIAN_TYPE      illegally #define'd in 'uC_cpu.h'   "
#error  "                         [MUST be  CPU_ENDIAN_TYPE_BIG   ]"
#error  "                         [     ||  CPU_ENDIAN_TYPE_LITTLE]"
#endif
...
#error  "CPU_CFG_STK_GROWTH             not #define'd in 'uC_cpu.h'    "
...
#error  "CPU_CFG_STK_GROWTH       illegally #define'd in 'uC_cpu.h'    "
#error  "                         [MUST be  CPU_STK_GROWTH_LO_TO_HI]"
#error  "                         [     ||  CPU_STK_GROWTH_HI_TO_LO]"
#endif
...
#error  "CPU_CFG_CRITICAL_METHOD        not #define'd in 'uC_cpu.h'             "
...
#error  "CPU_CFG_CRITICAL_METHOD  illegally #define'd in 'uC_cpu.h'             "
#error  "                         [MUST be  CPU_CRITICAL_METHOD_INT_DIS_EN  ]"
#error  "                         [     ||  CPU_CRITICAL_METHOD_STATUS_STK  ]"
#error  "                         [     ||  CPU_CRITICAL_METHOD_STATUS_LOCAL]"
#endif
