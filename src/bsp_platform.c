...
{                                                                          \
    ...
    __asm volatile("MSR     CPSR_CXSF, R0        ");     /*Write it back to enable IRQs */ \
...
{                                                                          \
    ...
    __asm volatile("MSR     CPSR_CXSF, R0        ");     /*Write it back to disable IRQs */\
    __asm volatile("POP     {R0}            ");                                           \
}
...
{
    HWREG(SOC_AINTC_REGS + INTC_CONTROL) = 
