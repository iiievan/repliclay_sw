...
public:
                        typedef struct i2cContext 
                        {
                         ...
                         HS_I2C(I2C::AM335x_I2C_Type & s_tmr);
                        ~HS_I2C() {};
             ...
             //uint32_t  slave_int_raw_status();
               ...
               uint32_t  active_own_address_get();
                 ...
                 //void  slave_data_put(uint32_t data);  
                   void  master_control(I2C::e_CON_flags cmd);
