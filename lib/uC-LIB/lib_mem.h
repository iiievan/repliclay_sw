...
*
*                   See also 'uC_cpu.h  CPU WORD CONFIGURATION  Note #2'.
*
...
*                   linked since each 'uC_cpu.h' SHOULD ensure that the CPU data-word-memory order configuration
*                   constant (CPU_CFG_ENDIAN_TYPE) is configured with an appropriate data-word-memory order
*                   value (see 'uC_cpu.h  CPU WORD CONFIGURATION  Note #2').  The 'else'-conditional code is
*                   included as an extra precaution in case 'uC_cpu.h' is incorrectly configured.
*********************************************************************************************************
*/
...
#error  "CPU_CFG_ENDIAN_TYPE  illegally #defined in 'uC_cpu.h'      "
#error  "                     [See 'uC_cpu.h  CONFIGURATION ERRORS']"
