...
static bool test_fsm_init(fsm_t* fsm)
{
    ...
    pin_set((e_AM3358_pins)DBG_PIN2_pin);
...
static bool test_fsm(fsm_t* fsm)
{
    ...
    if (repeats)
    {
        pin_toggle((e_AM3358_pins)USR_LED_1_pin);
...
{
    pin_set((e_AM3358_pins)DBG_PIN2_pin);  
    pin_clear((e_AM3358_pins)USR_LED_1_pin); 
    ...
    pin_clear((e_AM3358_pins)DBG_PIN2_pin);
...
static bool test_fsm_wait_delay(fsm_t* fsm)
{
    ...
    pin_toggle((e_AM3358_pins)DBG_PIN2_pin);
